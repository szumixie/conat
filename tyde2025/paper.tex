...
coinductive types is simpler. The third method in Section~\ref{quotiented} is
the one where we successfully formalised that conatural numbers form an
...
commutative semiring. In the proof we take advantage of univalence to transport
the exponential commutative semiring of expressions to conatural numbers. The

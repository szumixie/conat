...
has ended, we decrease both of them and increase $n$ by one. The diagram
illustrates the middle of this process. As we go through $x$ and $y$, we learn
that both of them must be at least~$n$, and during the proof we keep the proof
that adding $n$ to $x$ and $y$ gives us back the original values ($x_0$ and
$y_0$).
\begin{center}

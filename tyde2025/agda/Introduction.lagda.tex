...
making use of a mixed higher-inductive/coinductive type and the univalence
...
Sized types attaches ordinals to constructors, which allows corecursion to be
done by recursion on the sizes~\cite{hughes-sized, abel-delay}. This bypasses
the guardedness restriction, however, the current implementation of sized types
in Agda is inconsistent~\cite{abel-agda-sized}.

...
\AgdaDatatype{Maybe} of conatural numbers:
\begin{code}[hide]
...
In section~\ref{sec:direct}, we directly formalise every needed function, lemma,
property to prove commutativity of addition.

In section~\ref{sec:dsl}, we use Nils Anders Danielsson's
method~\cite{danielsson-beating} to formalise a proof language and use that
to prove commutativity of addition.
...
conatural numbers using the Martin-Löf identity type \textbf{(TODO: cite)}, one needs to

...
For the second formalisation we are going to use Nils Anders Danielsson's \cite{danielsson-beating}
method to make the definition of multiplication look structurally the same as in Section \ref{sec:problem}
and have Agda accept it without enabling unsafe features.

...
making \AgdaFunction{suc} the outermost function. This is because we do not have
congruence over \AgdaFunction{suc} in our language, but it could also be added

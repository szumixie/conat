...
\end{code}
The operations and equations that we added to \AgdaDatatype{Expr} are enough to
...
we had to modify the original \AgdaDatatype{Expr} datatype. As such, this method
